...
![三点估算](https://github.com/thomerson/BookNote/tree/master/source/images/三点估算.jpg)
...
* 关键路径法 Critical Path Method(CPM) 
	...
	* 自由浮动时间：不延误任何紧后活动最早开始日期或不违反进度制约因素的前提下，某进度活动可以推迟的时间量	
		* A->B B只有一个紧前活动A,那么A的自由浮动时间肯定是0，因为只要A延迟了肯定会影响B
...
* EAC
	...
	* EAC = AC + (BAC - EV)/CPI 典型 当前绩效[工期用SPI] [默认]
...
## 质量管理大师
![PDCA环](https://github.com/thomerson/BookNote/tree/master/source/images/PDCA环.PNG)
...
* 责任分配矩阵RAM
	...
	* RACI（执行、负责、咨询和知情）矩阵,每个任务的“A”只有一个[强调管理内部外部成员特别有用]
...
### 塔克曼阶梯理论
* 形成阶段： 相互认识，相互独立，不一定开诚布公。例如**增加新成员**
* 震荡阶段： **不同观点和意见**，有冲突。
* 规范阶段： 开始协同工作，学习相互信任。
* 成熟阶段： 组织有序，相互依靠，平稳高效。
* 解散阶段： 释放人员，解散团队
...
* 团队绩效评价
	...
	* 团队成员离职率的降低
	* 团队凝聚力的加强
* 事业环境因素更新:**团队成员的技能评估结果会记录在建设团队的输出事业环境因素中**
...
* 检查：可交付成果
* 审计：对采购过程的结构化审查
* 如果采购的东西有纠纷例如侵权等，取消合同(合同需要受法律法规保护，无效合同取消)
...
* 谁批准（A = Accountable）[唯一],即对任务负全责的角色，只有经他/她同意或签署之后，项目才能得以进行。
...
## 解决问题思路
定义问题->识别问题->生成方案->选择方案->执行->验证

## 协议

# 答题技巧

### 选项中有更新风险登记册[题干中有“可能”]/问题日志/相关方登记册 优先选择
...
## 变更题
* 本质是对项目管理计划（基准），可交付成果的修改
* 关注变更的受控，评估对项目管理计划（基准）的影响
* 关键字：新的，额外的，变化，工作遗漏，范围蔓延，缺陷补救
* 步骤

## 相关方
* 重点在管理人
* 关键字：反对，抱怨，担忧，抵制，威胁，不支持，不参与，事后提出不同意见
* 之前没有识别到：更新相关方登记册，做相关方分析和分类
* 已经识别：审查相关方参与计划，管理相关方参与（引导参与，获得支持；谈判沟通，管理期望；处理风险，预测问题；澄清和解决已识别的问题）
* 事先：早识别，早分析，早参与

## 沟通
* 重点在管理信息传递
* 关键字：多发，少发，没有及时发，看不懂，不是想要的，不方便阅读，虚拟团队沟通，相关方抱怨沟通不及时，虚拟团队误解
* 选择 审查/更新/创建 沟通管理计划
* 选择 沟通工具，沟通需求分析，沟通风格评估
...
## 静态投资回报期:越小越好
从项目的投建日期开始，用项目所得的净收益偿还原始投资所需要的年限

## 净现值NPV(net present value)：越大越好
未来的收益按照折现率折现之后与成本的差额，已经考虑了时间因素，所以越大越好！
NPV<0 表示项目不值得做
